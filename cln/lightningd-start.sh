...
/opt/cln/bin/lightningd --daemon --network=bitcoin --bitcoin-datadir /mnt/blockchain/btc-data/ --log-level debug --log-file=/mnt/blockchain/cln-data/debug.log --pid-file=/mnt/blockchain/cln-data/lightningd.pid 
