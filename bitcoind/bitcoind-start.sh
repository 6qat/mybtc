...
/mnt/disco/app/bitcoin/bin/bitcoind --daemon --server -pid=/mnt/disco/data/bitcoin/bitcoind.pid -datadir=/mnt/disco/data/bitcoin -debuglogfile=/mnt/disco/log/bitcoin.log -txindex=1 #-conf=/mnt/blockchain/btc-data/bitcoin.conf #-connect=10.8.0.3:8333 -connect=54.39.22.116:8333  -connect=187.55.40.86:8333 -connect=179.235.204.165:8333 -connect=186.218.58.150:8333
